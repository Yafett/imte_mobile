...
class enrollCardSmall extends StatefulWidget {
  const enrollCardSmall({
  ...
  @override
  State<enrollCardSmall> createState() => _enrollCardState();
}

class _enrollCardState extends State<enrollCardSmall> {
  String? scanResult;
